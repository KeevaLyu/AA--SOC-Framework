...
public interface CSUConstants {
    ...
    public static final String WORLD_HELPER_DEFAULT = "CSU_Yunlu_2021.world.CSUWorldHelper";
    public static final String WORLD_HELPER_FIRE_BRIGADE = "CSU_Yunlu_2021.world.CSUFireBrigadeWorld";
    public static final String FIRE_CLUSTERING = "CSU_Yunlu_2021.module.algorithm.fb.CSUFireClustering";
    public static final String GRAPH_HELPER_DEFAULT = "CSU_Yunlu_2021.world.graph.GraphHelper";
    public static final String GUIDE_LINE_CREATOR = "CSU_Yunlu_2021.module.complex.pf.GuidelineCreator";
    public static final String SEARCH_HELPER = "CSU_Yunlu_2021.module.complex.fb.search.SearchHelper";
    public static final String A_STAR_PATH_PLANNING = "CSU_Yunlu_2021.module.algorithm.AStarPathPlanning";
