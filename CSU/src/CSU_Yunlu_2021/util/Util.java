...
//        Line l = new Line((int) entrance.getOrigin().getX(), (int) entrance.getOrigin().getY(), (int) entrance.getEndPoint().getX(), (int) entrance.getEndPoint().getY());
	...
	public static rescuecore2.misc.geometry.Point2D getPointInDistance(java.awt.geom.Line2D line, rescuecore2.misc.geometry.Point2D from, double distance) {
